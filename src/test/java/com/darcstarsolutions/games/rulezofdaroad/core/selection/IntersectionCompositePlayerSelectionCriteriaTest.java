...
public class IntersectionCompositePlayerSelectionCriteriaTest {

	@Resource
	private Player defaultPlayer;

	private IntersectionCompositePlayerSelectionCriteria criteria;
	...
	public void setUp() throws Exception {
		...
		criteria = new IntersectionCompositePlayerSelectionCriteria(criterias);
	}
	...
	public void testMatches() {
		minimumScoreBasedPlayerSelectionCriteria.setScore(0);
		assertTrue(minimumScoreBasedPlayerSelectionCriteria
				.matches(defaultPlayer));
		includeNamedPlayerSelectionCriteria.setName(Player.DEFAULT_PLAYER_NAME);
		assertTrue(includeNamedPlayerSelectionCriteria.matches(defaultPlayer));
		assertTrue(maximumScoreBasedPlayerSelectionCriteria
				.matches(defaultPlayer));
